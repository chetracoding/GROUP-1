...
<div class="flex p-5 mx-11 my-10 bg-gray-800 ">
    ...
    <div class="flex flex-col bg-white p-5 border-l-4 border-stone-200 w-3/4 text-black">
      ...
      <div class="text-xl h-3/4 text-black mt-5">
          <div class="flex gap-2">
            <i class="text-blue-600 fa-regular fa-house"></i>
          ...
          <div class="flex gap-2">
            <i class="text-blue-600 fa-regular fa-timer"></i>
  ...
  <!--  -->
  <div class="flex flex-col  p-5 border-l-4 border-stone-200 w-2/4 text-black">
    <div id="credit-card">
        <h1 class="font-bold text-white text-2xl text-center pb-8">Confirm Purchase</h1>
        <div class="mb-6">
