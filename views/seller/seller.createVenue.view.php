        ...
        <div class="w-full flex flex-col items-center justify-center px-8 py-8 shadow mt-10">
            ...
            <form class="w-full space-y-4 " method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea id="address" name="address"  rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-green-400 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your address here..."><?= isset($_POST['address'])? $_POST['address'] : ""?></textarea>
