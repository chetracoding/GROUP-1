...
<div class="flex justify-center align-center my-8">
    <div class="w-2/5 md:space-y-8 sm:p-15 mx-14 mb- bg-gray-50 mb-2 p-8 my-20 shadow-lg">
        <form action="/codesecurity" method="POST" class="space-y-4 md:space-y-6">
            ...
            <div>
                <input type="number" id="number" name="pin-code" placeholder="Security code" class="bg-gray-50 border border-green-400 sm:text-sm rounded-lg focus:ring-1.5 focus:ring-green-500 font-medium block w-full p-2.5 dark:focus:ring-green-500 dark:focus:border-green-300">
