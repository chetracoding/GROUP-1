...
<div class="flex items-center justify-center">
    <p class="font-com text-2xl font-semibold text-white rounded-full bg-blue-900 py-2 px-3.5 my-10">NEW SHOWS</p>
  </div>
  <div class="flex min-h-screen items-center justify-center ">

    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-10">
      <?php foreach($shows as $show): ?>
      <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      <div class="h-65 w-50">
        <img class="h-full w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src=<?= $show['image']?> alt="" />
      </div>
